...
def test_generate_context_files(workspace_root, sample_config):
    ...
    # The companion human-testing guide is written next to CLAUDE.md and
    # referenced from it (loaded only when the agent reaches the testing phase).
    guide = workspace_root / "CHAT_TESTING.md"
    assert guide.exists()
