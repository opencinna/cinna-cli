...
| **Agent addons** | `cinna skills` (list, publish) — installed plugins + the agent's own `skills/<name>/` folders, and publishing one to the skills catalog | [business](features/agent_addons/agent_addons.md) · [tech](features/agent_addons/agent_addons_tech.md) · [acceptance](features/agent_addons/agent_addons_acceptance.md) |
